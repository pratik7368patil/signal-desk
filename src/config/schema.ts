      ...
      oauth: z
        .object({
          ...
          scopes: z
            ...
            .default(["app_mentions:read", "commands", "chat:write", "users:read", "channels:history", "reactions:write"]),
        ...
        .default({
          ...
          scopes: ["app_mentions:read", "commands", "chat:write", "users:read", "channels:history", "reactions:write"],
